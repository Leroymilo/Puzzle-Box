...
def mkLvlScene(Window, pages, pageId) :
    ...
    if pages is not None :
        ...
        y = Coords[0, 0][1] + 175
        butt = Button((x1, y), (45, 90), (0, 0, 100), '', ["prev page"])
        Levels.addButton(butt)
        butt = Button((x2, y), (45, 90), (0, 0, 100), '', ["next page"])
        Levels.addButton(butt)
...
def AddButtons(Window) :
    ...
    butt = Button(C[2, 0], (450, 100), (0, 200, 0), 'Play', ["change scene", 'Levels'])
    Title.addButton(butt)
    butt = Button(C[3, 0], (450, 100), (0, 200, 0), 'Settings', ["change scene", 'Settings'])
    Title.addButton(butt)

    C = buttonGrid(Window, 450, 100, 1, 2, 50)
    butt = Button(C[0, 0], (450, 100), (0, 200, 0), 'Load', ["change scene", 'Load'])
    ...
    butt = Button(C[0, 0], (450, 100), (0, 200, 0), 'Save 1', ["load save", 1])
    Load.addButton(butt)
    butt = Button(C[1, 0], (450, 100), (0, 200, 0), 'Save 2', ["load save", 2])
    Load.addButton(butt)
    butt = Button(C[2, 0], (450, 100), (0, 200, 0), 'Save 3', ["load save", 3])
    Load.addButton(butt)

    C = buttonGrid(Window, 450, 100, 1, 2, 50)
    butt = Button(C[0, 0], (450, 100), (200, 0, 0), 'Clear save progress', ["clear"])
    Clear.addButton(butt)
    butt = Button(C[1, 0], (450, 100), (0, 200, 0), 'Fuck go back', ["change scene", 'Settings'])
    Clear.addButton(butt)
